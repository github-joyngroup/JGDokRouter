...
{
    public class InstructionInstanceFromIntDictionarySerializer : IBsonSerializer<Dictionary<int, InstructionInstance>>
    {
        public Type ValueType => typeof(Dictionary<int, InstructionInstance>);

        // Type-specific Serialize method
        public void Serialize(BsonSerializationContext context, BsonSerializationArgs args, Dictionary<int, InstructionInstance> value)
        {
        ...
        public Dictionary<int, InstructionInstance> Deserialize(BsonDeserializationContext context, BsonDeserializationArgs args)
        {
            var result = new Dictionary<int, InstructionInstance>();
            ...
            while (reader.ReadBsonType() != BsonType.EndOfDocument)
            {
                ...
                var value = BsonSerializer.Deserialize<InstructionInstance>(reader);
        ...
        {
            Serialize(context, args, (Dictionary<int, InstructionInstance>)value); // Cast and call the type-specific Serialize method
        }
    }
